...
/**
 * Timer interrupt for involuntary task switching
 * Measure interrupt disabled time
 */
...
void Setup_Interrupt_Timer() {
    ...
    // 249 = 1000 Hz,
    // 2499 = 100 Hz,
    // 30000 Hz for visible LED blink
    OCR1A = 2499;
...
void Setup_IO_Ports() {
    ...
    //DDRA |= (1 << PA0); //set PA2 to output

}


/**
  * This function creates two tasks which switch involuntarily. Both
  * will run forever.
  */
void main() {
